...
<img id="loginlogo" src="uploads/login2.jpg" alt="">
    <div class="card2">
        <form class="form" method="POST">
            ...
            <div class="btn">
                <input type="submit" value="Login" class="button1" name="submit"/>
             ...
             <button class="button3"><a href="forget.php" style="text-decoration:none; color:white;">Forgot Password</a></button>
        </form>
    </div>
</div>
...
if(isset($_POST['submit'])){
    ...
    echo "<script> error_msg.innerHTML='Invalid Username or Password'; error_box.style.visibility='visible'; error_box.style.position='relative'</script>";
  }
}
?>